        ...
        <Content>
          <Description>
            <p>
              ...
              for player
              <br></br>redirection after ending of the game session. A game can
              be launched provider side based on the game launch URL template
              provided by the Playtron.
            </p>
            <p>
              Playtron should provide a way to launch an individual product by
              the identifier in the format described below.
            </p>
            <p>The template should be of the form:</p>
            <p>Where:</p>
            <p>
              ❏ game_provider_base_url is a base URL where game launch
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>String (255)</td>
                <td>
                  Product id to be launched (game identifier). GameId provided
                  by the provider
                </td>
              </tr>
              <tr>
                ...
                <td>String (255)</td>
                <td>
                  Session token which identifies unique player id on the
                  operator side. Generated by operator
                </td>
              </tr>
              <tr>
                <td>lang</td>
          ...
          <div>
            ...
            <div>
              <p>
                Once the game is launched then the Playtron should produce
                wallet requests to:
              </p>
